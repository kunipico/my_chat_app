...
DROP DATABASE mychatapp;
DROP USER 'mychatappuser'@'localhost';

CREATE USER 'mychatappuser'@'localhost' IDENTIFIED BY 'mychatappuser';
CREATE DATABASE mychatapp;
USE mychatapp
GRANT ALL PRIVILEGES ON mychatapp.* TO 'mychatappuser'@'localhost';
